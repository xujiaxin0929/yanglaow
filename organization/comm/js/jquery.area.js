...
function selectD(p,c,d) {
	...
	if(expressArea.split('>')[0].trim()=='北京市'||expressArea.split('>')[0].trim()=='上海市'||expressArea.split('>')[0].trim()=='重庆市'||expressArea.split('>')[0].trim()=='天津市')
	{
		var pro=expressArea.split('>')[0].trim();
		var city=expressArea.split('>')[0].trim();
		var country=expressArea.split('>')[1].trim();
		expressArea=pro+'>'+city+'>'+country
	}
	$("#expressArea").val(expressArea);
}
